module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      dist: {
        files: {
          ...
          'static/dist/vendor/alertify.built.css': 'static/vendor/alertifyjs/sass/alertify.scss'
        }
      }
    },
    eslint: {
      src: ['static/js/*.js', '!js/vendor/**/*.js', 'vendor/alertifyjs/**']
    },
    babel: {
      options: {
        sourceMap: true,
      ...
      dist: {
        files: {
          ...
          'static/dist/vendor/alertify.built.js': 'static/vendor/alertifyjs/js/alertify.js',
          'static/dist/vendor/sweetalert.built.js': 'static/vendor/sweetalert/js/sweetalert.js'
        }
      }
    },
    uglify: {
      ...
      build: {
        files: {
          ...
          'static/dist/vendor/alertify.min.js': 'static/dist/vendor/alertify.built.js',
          'static/dist/vendor/sweetalert.min.js': 'static/dist/vendor/sweetalert.built.js'
        }
      }
    },
    minjson: {
    ...
    watch: {
      ...
      js: {
        files: ['static/js/**/*.js', 'static/vendor/**/**/**'],
    ...
    cssmin: {
      ...
      build: {
        files: {
          ...
          'static/dist/vendor/alertify.min.css': 'static/dist/vendor/alertify.built.css',
          'static/dist/vendor/sweetalert.min.css': 'static/vendor/sweetalert/css/sweetalert.css'
        }
      }
    }
  });
